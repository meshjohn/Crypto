...
const Trade = () => {
  ...
  return (
    <section className="section lg:pt-[320px] bg-gradient-to-b from-[#f8f9f7] to-[#fafbff] text-darkblue lg:-mt-[320px]">
      <div className="container mx-auto">
        <h2 data-aos='fade-up' data-aos-offset='400' className="section-title text-center mb-16">
          Trade securely and market the high growth cryptocurrencies.
        </h2>
        {/* items */}
        <div data-aos='fade-up' data-aos-offset='450' className="flex flex-col gap-[45px] lg:flex-row">
          {currency.map((item, index) => {
            ...
            return (
              <div
                ...
                } w-full rounded-2xl py-12 px-6 shadow-primary cursor-pointer transition duration-300" key={index}`}
              >
